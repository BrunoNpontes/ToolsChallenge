...
public enum ResponseExceptionEnum {
    ...
    TRANSACTION_NOT_FOUND_CANCELED(HttpStatus.NOT_FOUND, "Não a transações", MessagesExceptions.TRANSACTION_NOT_FOUND_CANCELED),
    TRANSACTION_NOT_FOUND_CANCELED_BY_ID(HttpStatus.NOT_FOUND, "Não a transações", MessagesExceptions.TRANSACTION_NOT_FOUND_CANCELED_BY_ID );
